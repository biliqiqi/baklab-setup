function loadConfigReview(config) {
    try {
        const configData = config.getAll();

        const corsText = window.i18n ? window.i18n.t('setup.review.cors_configured', { count: configData.app.cors_allow_origins.length }) :
                        `${configData.app.cors_allow_origins.length} configured`;

        const serviceTypeText = window.i18n ? window.i18n.t(`setup.database.service_type_${configData.database.service_type}`) : configData.database.service_type;
        let databaseSection = `
        ...
        document.getElementById('config-review').innerHTML = `
            <div style="text-align: left;">
                ...
                <p><strong data-i18n="setup.review.fields.service_type"></strong>: ${window.i18n ? window.i18n.t(`setup.redis.service_type_${configData.redis.service_type}`) : configData.redis.service_type}</p>
                ...
                <p><strong data-i18n="setup.review.fields.jwt_mode"></strong>: ${configData.app.jwt_key_from_file ? (window.i18n ? window.i18n.t('setup.review.jwt_from_file') : 'From File') : (window.i18n ? window.i18n.t('setup.review.jwt_auto_generate') : 'Auto Generate')}</p>
                ...
                <p><strong data-i18n="setup.review.fields.ssl_enabled"></strong>: ${configData.ssl.enabled ? (window.i18n ? window.i18n.t('common.yes') : 'Yes') : (window.i18n ? window.i18n.t('common.no') : 'No')}</p>
                ${configData.ssl.enabled ? `
                    ...
                    <p><strong data-i18n="setup.review.fields.ssl_use_setup_cert"></strong>: ${configData.ssl.use_setup_cert ? (window.i18n ? window.i18n.t('common.yes') : 'Yes') : (window.i18n ? window.i18n.t('common.no') : 'No')}</p>
                ` : ''}
                ...
                <p><strong data-i18n="setup.review.fields.google_oauth"></strong>: ${configData.oauth.google_enabled ? (window.i18n ? window.i18n.t('setup.review.fields.oauth_enabled') : 'Enabled') : (window.i18n ? window.i18n.t('setup.review.fields.oauth_disabled') : 'Disabled')}</p>
                <p><strong data-i18n="setup.review.fields.github_oauth"></strong>: ${configData.oauth.github_enabled ? (window.i18n ? window.i18n.t('setup.review.fields.oauth_enabled') : 'Enabled') : (window.i18n ? window.i18n.t('setup.review.fields.oauth_disabled') : 'Disabled')}</p>

                <h4 style="margin-top: 1.5rem;" data-i18n="setup.review.sections.goaccess"></h4>
                <p><strong data-i18n="setup.review.fields.goaccess_enabled"></strong>: ${configData.goaccess.enabled ? (window.i18n ? window.i18n.t('common.yes') : 'Yes') : (window.i18n ? window.i18n.t('common.no') : 'No')}</p>
...
export function render(container, { config, navigation, setupService }) {
        container.innerHTML = `
